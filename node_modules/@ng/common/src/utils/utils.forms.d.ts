...
export default class Forms {
     ...
     */
    static hasErrorCustom(form: NgForm | FormGroup, controls: string[], submitted?: boolean): boolean;
    /**
     ...
     * @param submitted Indication whether form was submitted
     */
    static alertHiddenCustom(form: NgForm | FormGroup, control: string, errors?: string[], submitted?: boolean): boolean;
    /**
     * Gets indication whether controls have errors
     * @param form Form containing controls
     * @param controls Array of controls names to be checked for errors
     */
    static hasError(form: NgForm, controls: string[]): boolean;
    /**
     ...
     * @param errors Array of validation errors to be checked for existance
     */
    static alertHidden(form: NgForm, control: string, errors?: string[]): boolean;
}
