...
export declare class OptGroupComponent<TValue> implements NgSelectOptGroup<TValue>, AfterViewInit {
    ...
    static ngComponentDef: ɵngcc0.ɵComponentDefWithMeta<OptGroupComponent<any>, "ng-select>optgroup", never, { 'text': "text" }, {}, never>;
}

//# sourceMappingURL=D:/git/ivy-code-size/node_modules/@ng/sample/src/components/option/optgroup.component.d.ts.map