...
export declare class OptionComponent<TValue> implements NgSelectOption<TValue> {
     ...
     */
    group: string;
    static ngComponentDef: ɵngcc0.ɵComponentDefWithMeta<OptionComponent<any>, "ng-select option", never, { 'value': "value", 'text': "text" }, {}, never>;
}

//# sourceMappingURL=D:/git/ivy-code-size/node_modules/@ng/sample/src/components/option/option.component.d.ts.map